...
st.markdown("### 🎨 Paleta de Colores Activa")
st.markdown(f"""
    <style> .color-box {{ width: 30px; height: 30px; border-radius: 5px; margin: 5px 0; }} </style>
    <div style="display: flex; justify-content: space-around; flex-wrap: wrap;">
        <div>Fondo: <div class="color-box" style="background-color: {COLOR_FONDO};"></div></div>
        <div>Texto: <div class="color-box" style="background-color: {COLOR_TEXTO}; border: 1px solid #ccc;"></div></div>
        <div>Primario: <div class="color-box" style="background-color: {COLOR_PRIMARIO};"></div></div>
        <div>Código: <div class="color-box" style="background-color: {COLOR_BLOQUE_CODIGO};"></div></div>
        <div>Texto Cód: <div class="color-box" style="background-color: {COLOR_TEXTO_CODIGO};"></div></div>
        <div>Selector: <div class="color-box" style="background-color: {COLOR_SELECTOR};"></div></div>
    </div>
