...
st.markdown("<p style='text-align: center;'>Cambia de sifrado latino a cifrado americano y agrega un apóstrofe (') para detectar las notas.</p>", unsafe_allow_html=True)
