...
if archivo:
    ...
    if st.button("✨ PROCESAR"):
        ...
        components.html(f"""
            <button id="btn"
        style="padding: 10px 20px !important; background: #FF4B4B; color: white; border: none; border-radius: 12px; font-weight: bold; cursor: pointer; font-size: 16px;">💾 GUARDAR Y COMPARTIR</button>
            <script>
