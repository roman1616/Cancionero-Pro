...
st.markdown("<p style='text-align: center;'>Cambia de cifrado latino (La) a cifrado americano (A) y le agrega un apóstrofe (') para identificar los acordes.</p>", unsafe_allow_html=True)
